...
| 2   |        | <-        |                        | `loans` (array di oggetti con `id`, `requestDate`, `loanStartDate`, `terminationDate`, `product` (oggetto con: `id`, `title`), `borrower` (oggetto con `id`, `name`, `surname`)) |
